...
export default function SetupGameScreen() {
  ...
  return (
    <View className="flex-1 bg-[#1C1B1B]">
      ...
      {/* CONTENEDOR PRINCIPAL: KeyboardAvoidingView ENVOLVIENDO TODO */}
      <KeyboardAvoidingView
        // 1. Padding para iOS, height o undefined para Android suele funcionar mejor dependiendo del manifest
        behavior={Platform.OS === "ios" ? "padding" : "height"} 
        // 2. IMPORTANTE: El offset compensa el Header fijo de arriba (aprox 100-110px)
      ...
      >
        <DraggableFlatList
          ...
          // 3. PADDING GIGANTE AL FINAL:
          // Esto permite hacer scroll mucho más allá del final, 
          // para que el último input suba por encima del teclado y del botón.
          contentContainerStyle={{
            paddingHorizontal: 24,
            paddingBottom: 150, // <--- AUMENTADO (Antes 40)
            paddingTop: 10,
          }}
